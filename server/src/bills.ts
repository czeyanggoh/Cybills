...
billsRouter.patch('/bills/:id', (req, res) => {
  ...
  for (const k of ['supplier', 'invoiceNumber', 'documentType', 'currency', 'date', 'category', 'categoryReason', 'taxRate', 'description', 'status', 'createdBy', 'paymentMethod', 'customer', 'project', 'cardLast4']) {
