...
check('the reader is offered "Mileage" as a document type', props.documentType?.enum, ['Receipt', 'Invoice', 'Payment proof', 'Quotation', 'Pro-forma invoice', 'Mileage', 'Other']);
