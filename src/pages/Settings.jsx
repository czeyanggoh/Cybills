    ...
    <div className="space-y-6">
      ...
      <Card title="Publishing">
        <Row
          ...
          hint="What Publish to Xero posts a bill as, wherever somebody presses it — the dialog opens on it, and the inbox's bulk publish and a claim's use it too. Only an Approved bill can take a payment in Xero, so that is what a bill has to reach before the money can leave. Publishing automatically after reading is separate: set per supplier on its rule (Approved or Awaiting approval), or for every supplier with the switch under Tax, which posts as Awaiting approval."
        >
          <SelectBox
      ...
      <Card title="Tax">
        ...
        {!bridge && (
          <Row
            ...
            hint="Off by default. When on, an UPLOADED document that's been read is posted straight to Xero as Awaiting Approval — which means nobody checks the reading first, and publishing finishes the document: it archives, and can no longer go on an expense claim. Only complete documents are posted; anything missing a supplier, date, category or total stays here to publish by hand. To publish one supplier's documents as Approved, on every road including email and WhatsApp, set it on that supplier's rule instead."
          >
